...
export default function CropTypesManagerPage() {
  ...
  const isLoading = isProfileLoading || isLoadingCropTypes;
                                ...
                                <CardContent>
                                    <ul className="text-sm space-y-1">
                                        <li className="flex justify-between items-baseline">
                                            ...
                                            <span className="font-semibold">{ct.rates ? ct.rates['6'] : '0'} Rp</span>
                                        </li>
                                        <li className="flex justify-between items-baseline">
                                            <span className="text-muted-foreground">1 Year:</span>
                                            <span className="font-semibold">{ct.rates ? ct.rates['12'] : '0'} Rp</span>
                                        </li>
                                        <li className="flex justify-between items-baseline mt-2 pt-2 border-t">
                                            <span className="text-muted-foreground">Insurance:</span>
                                            <span className="font-semibold">{ct.insurance || '0'} Rp</span>
                                        </li>
                                    </ul>
                                </CardContent>
                            </Card>
